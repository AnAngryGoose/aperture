...
<div class="card placeholder-card">
	<div class="placeholder-content">
		...
		<h2>System Logs</h2>
		<p>Host-level log streaming (journald, syslog) coming in a future release. Container logs are available on the Containers tab.</p>
	</div>
</div>
...
<style>
	...
	p { margin: 0; font-size: 13px; max-width: 360px; }
</style>
